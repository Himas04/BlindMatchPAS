    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Machine learning, deep learning, NLP", true, "Artificial Intelligence" },
                    { 2, "Frontend, backend, full-stack", true, "Web Development" },
                    { 3, "Network security, cryptography, ethical hacking", true, "Cybersecurity" },
                    { 4, "AWS, Azure, GCP, distributed systems", true, "Cloud Computing" },
                    { 5, "iOS, Android, cross-platform", true, "Mobile Development" },
                    { 6, "Data analysis, visualization, big data", true, "Data Science" }
                });
